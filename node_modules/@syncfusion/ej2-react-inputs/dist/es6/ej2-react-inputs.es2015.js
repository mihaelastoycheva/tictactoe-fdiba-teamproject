...
class TextAreaComponent extends TextArea {
    ...
    render() {
        if (((this.element && !this.initRenderCalled) || this.refreshing) && !this.isReactForeceUpdate) {
            ...
            return createElement('textarea', this.getDefaultAttributes(), [].concat(this.props.children, this.portals));
        }
    }
}
...
export { TextBoxComponent, TextAreaComponent, NumericTextBoxComponent, MaskedTextBoxComponent, SliderComponent, UploadedFilesDirective, FilesDirective, UploaderComponent, ColorPickerComponent, SignatureComponent, RatingComponent };
